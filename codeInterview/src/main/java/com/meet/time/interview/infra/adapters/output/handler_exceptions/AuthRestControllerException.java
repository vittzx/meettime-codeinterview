...
import com.meet.time.interview.infra.adapters.input.OAuthtRestController;
...
@Slf4j
@RestControllerAdvice(assignableTypes = OAuthtRestController.class)
@Order(Ordered.HIGHEST_PRECEDENCE)
@RequiredArgsConstructor
public class AuthRestControllerException extends ResponseEntityExceptionHandler {
